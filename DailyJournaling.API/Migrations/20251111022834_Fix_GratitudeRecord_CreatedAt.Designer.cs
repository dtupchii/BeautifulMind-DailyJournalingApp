...
namespace DailyJournaling.API.Migrations
{
    ...
    [Migration("20251111022834_Fix_GratitudeRecord_CreatedAt")]
    partial class Fix_GratitudeRecord_CreatedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DailyJournaling.API.Models.Answer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AnswerId = new Guid("a1b2c3d4-e5f6-4789-0abc-def123456789"),
                            GratitudeRecordId = new Guid("d3b5f3a1-3c4e-4f5a-9f7e-1a2b3c4d5e6f"),
            ...
            modelBuilder.Entity("DailyJournaling.API.Models.GratitudeRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GratitudeRecordId = new Guid("d3b5f3a1-3c4e-4f5a-9f7e-1a2b3c4d5e6f"),
                            CreatedAt = new DateTime(2025, 11, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            DayPartId = new Guid("ae21d84f-1f1a-4d63-a1cd-edcc41722a6c"),
